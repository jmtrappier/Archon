import { BarChart3, ChevronRight, ExternalLink, Flag, Users } from "lucide-react";
...
import type { HierarchyStatus, Priority, Story, StoryWithEpic } from "../types";
import {
...
export const StoryCard: React.FC<StoryCardProps> = ({
  ...
  const handleTaskDrop = useCallback(
    async (draggedItem: DraggedTask, targetId: string) => {
  ...
  const sizeClass = compact ? "min-h-[80px]" : getStorySizeClass(!!story.description, isExpanded);
            ...
            >
              ...
              <div className={`flex flex-col h-full ${compact ? "p-2" : "p-4"}`}>
                ...
                <div className="flex items-start justify-between mb-3 pl-1">
                  ...
                  {/* Action buttons */}
                  <div
                    className={`flex items-center gap-1 ${STORY_HOVER_EFFECTS.actions} transition-opacity duration-200`}
                  >
                    {onViewTasks && (
                      <Tooltip>
