...
export const HierarchyDetailsPanel: React.FC<HierarchyDetailsPanelProps> = ({
  ...
  return (
    <>
      <Card className="h-full overflow-auto scrollbar-thin border-slate-200/70 bg-white/80 shadow-md backdrop-blur dark:border-slate-800/60 dark:bg-slate-900/70">
        <CardHeader>
