/**
 * HierarchyNodeWithDependencies - Enhanced HierarchyNode with dependency badges
 *
 * Extends the base HierarchyNode component to display dependency information
 * as badges next to the node content.
 */
...
import { DependencyBadge } from "../../dependencies/components/DependencyBadge";
...
import type { HierarchyDependencyStats } from "../../dependencies/services/hierarchyDependencyService";
...
interface HierarchyNodeWithDependenciesProps {
  ...
  isDimmed: boolean;
  dependencyStats?: HierarchyDependencyStats;
}

export const HierarchyNodeWithDependencies: React.FC<HierarchyNodeWithDependenciesProps> = ({
  node,
  depth,
  hasChildren,
  isExpanded,
    ...
    >
      <div
        className={cn(
          ...
          // Add special highlighting for nodes with dependency issues
          dependencyStats?.hasConflicts && "border-orange-200 dark:border-orange-800",
          dependencyStats?.inCycle && "border-red-200 dark:border-red-800",
        )}
        ...
        <div className="flex min-w-0 flex-1 items-center gap-3">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              ...
              {/* Dependency Badge */}
              {dependencyStats && node.type !== 'project' && (
                <DependencyBadge
...
export default HierarchyNodeWithDependencies;